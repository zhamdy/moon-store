...
import { ILabelTemplatesRepository, labelTemplatesRepository as defaultRepo } from './repository';
import { CreateLabelTemplateDTO, UpdateLabelTemplateDTO, LabelTemplateRecord } from './types';
