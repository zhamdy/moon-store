...
// `eslint --config apps/dashboard/eslint.config.mjs` with the repo root as cwd, not `apps/dashboard/`.
...
export default tseslint.config(
  ...
  eslintConfigPrettier,
  {
    ...
    settings: {
      ...
      // "apps/dashboard/src/features/..." from the repo root but "src/features/..."
      // from apps/dashboard/, and every `src/**` pattern below silently stops
