      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 space-y-4">
          ...
          */}
          ...
          {/* Bundles section. Postponed: the strip stays hidden even if `bundles`
              somehow carries data, since handleBundleClick and cart plumbing
              must keep working for historical/priced lines. */}
          {!isPostponedPath(BUNDLES_PATH) && bundles && bundles.length > 0 && products && (
            <div className="space-y-2">
              <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
