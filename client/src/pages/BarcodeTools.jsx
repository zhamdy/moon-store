  ...
  const handleBulkPrint = () => {
    ...
    const barcodeHtml = selectedProducts.map((p) => `
      <div style="display:inline-block;width:45%;margin:2%;padding:16px;border:1px solid #ccc;text-align:center;">
        ...
        <p style="margin:2px 0;font-size:18px;font-weight:bold;">$${parseFloat(p.price).toFixed(2)}</p>
      </div>
    `).join('');
                    ...
                    onClick={() => {
                      ...
                      printWindow.document.write(`
                        ...
                        <div style="text-align:center;">
                          ...
                          <p style="font-size:20px;font-weight:bold;">$${parseFloat(selectedProduct.price).toFixed(2)}</p>
                        </div>
                        <script>
