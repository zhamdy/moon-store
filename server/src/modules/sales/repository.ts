...
export interface ISalesRepository {
  findById(id: number, queryable?: Queryable): Promise<Record<string, any> | null>;
  findItemsBySaleId(saleId: number, queryable?: Queryable): Promise<Record<string, any>[]>;
  findPaymentsBySaleId(saleId: number, queryable?: Queryable): Promise<Record<string, any>[]>;
  findRefundsBySaleId(saleId: number, queryable?: Queryable): Promise<Record<string, any>[]>;
  listSales(
    filters: SaleFilters,
    queryable?: Queryable
...
export class SalesRepository implements ISalesRepository {
  ...
  async findById(id: number, queryable?: Queryable): Promise<Record<string, any> | null> {
  ...
  async findItemsBySaleId(saleId: number, queryable?: Queryable): Promise<Record<string, any>[]> {
    const res = await this.q(queryable).query(
  ...
  async findRefundsBySaleId(saleId: number, queryable?: Queryable): Promise<Record<string, any>[]> {
    const res = await this.q(queryable).query(
